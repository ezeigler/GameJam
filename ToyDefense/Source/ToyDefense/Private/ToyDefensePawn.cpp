...
void AToyDefensePawn::Tick(float DeltaSeconds)
{
...
void AToyDefensePawn::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AToyDefensePawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
